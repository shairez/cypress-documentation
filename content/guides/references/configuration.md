...
| `supportFile`     | `cypress/support/e2e.{js,jsx,ts,tsx}` [<Icon name="question-circle"/>](/guides/references/error-messages#use-supportfile-to-load-scripts-before-your-test-code) | Path to file to load before test files load. This file is compiled and bundled. (Pass `false` to disable)                                                                                           |
...
| `setupNodeEvents` | `null`                                                                                                                                                                | Function in which node events can be registered and config can be modified. Takes the place of the (deprecated) plugins file. [Please read the notes for examples on using this.](#setupNodeEvents) |
| `supportFile`     | `cypress/support/component.{js,jsx,ts,tsx}` [<Icon name="question-circle"/>](/guides/references/error-messages#use-supportfile-to-load-scripts-before-your-test-code) | Path to file to load before test files load. This file is compiled and bundled. (Pass `false` to disable)                                                                                           |
